...
public class MapGenerator : MonoBehaviour
{
	...
	public TerrainDataCustom terrainData;
	...
	public float GetRealWorldChunkSize()
	{
		return mapChunkSize * terrainData.uniformScale;
	}
	...
	{
		SystemRandom prng = new SystemRandom(noiseData.seed);

		float[,] noiseMap = Noise.GenerateNoiseMap(mapChunkSize + 2, mapChunkSize + 2, prng, 
